...
`GET http://localhost:3000/disco/6537976d41d7832e800d2b11`
...
`GET http://localhost:3000/disco/nombre/Dark%20Side%20of%20the%20Moon`
...
`GET http://localhost:3000/disco/formato/Vinilo`
...
`POST http://localhost:3000/addDisco` y añadir un cuerpo con estas características:
````json
{
    "nombre": "Más",
    "autor": "Alejandro Sanz",
...
`DELETE http://localhost:3000/deleteDisco/6530fdc36770dc41ec1afc45`
